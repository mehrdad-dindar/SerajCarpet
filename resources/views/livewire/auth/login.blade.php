<div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="p-6 pb-0 mb-0 bg-transparent border-b-0 rounded-t-2xl">
                                    <span
                                        class="relative z-10 font-bold text-transparent bg-gradient-cyan bg-clip-text">{{ __("To") }}</span>
                                ...
                                <div class="flex-auto p-6">
                                    ...
                                    <form wire:submit="login">
                                        <div class="{{ $codeSent ? "hidden" : "block" }}">
                                            <label
                                            ...
                                            <div class="mb-4">
                                                <input wire:model.lazy="phone" type="text"
                                                       ...
                                                       name="phone" id="phone" placeholder="09123456789"
                                                       aria-label="Phone"
                                            ...
                                            <div class="text-center">
                                                <button type="button" wire:click="sendCode" id="send_code"
                                        ...
                                        <div class="{{ !$codeSent ? "hidden" : "block" }}">
                                            <label
                                                class="mb-2 ml-1 font-bold text-size-xs text-slate-700">{{ __("Verify Code") }}</label>
                                            <div class="mb-4">
                                            ...
                                            <div>
                                                زمان باقی‌مانده: <span id="timer" class="inline-flex items-center rounded-md bg-fuchsia-50 px-2 py-1 text-sm font-medium text-fuchsia-400 ring-1 ring-inset ring-fuchsia-500/10">02:00</span> ثانیه
                                            </div>
                                            <div class="text-center">
                                                <button type="submit"
    ...
    <script>
        ...
        document.addEventListener('startTimer', function () {
            startTimer(2 * 60, document.getElementById('timer'));

            function startTimer(duration, display) {
                // console.log('hi')
                // console.log(display)
                // console.log('display')
                // if (!display) return; // اگر عنصر #timer وجود نداشت، عملیات را متوقف کن

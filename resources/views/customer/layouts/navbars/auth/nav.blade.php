  ...
  <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
    <nav>
      ...
      <ol class="flex flex-wrap pt-1 bg-transparent rounded-lg">
        ...
        <li
          class="text-size-sm pl-2 capitalize leading-normal text-slate-700 {{ (true ? 'before:float-right before:pl-2' : 'before:float-left before:pr-2') }}{{--Request::is('rtl')--}} before:text-gray-600 before:content-['/']"
    ...
    <div
      ...
      <ul
        class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full {{ (true ? 'pr-10 ml-0 mr-auto' : '') }}{{--Request::is('rtl')--}}">
          <!-- notifications -->
          <li class="relative flex items-center {{ (true ? 'pl-2' : 'pr-2') }}{{--Request::is('rtl')--}}">

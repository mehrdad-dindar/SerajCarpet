  ...
  <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 block w-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 {{ (true ? 'xl:right-0 mr-4 translate-x-full' : 'xl:left-0 ml-4 -translate-x-full ') }}{{--Request::is('rtl')--}} xl:translate-x-0 xl:bg-transparent
    ...
    <div class="h-19.5">
      ...
      <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="{{ url('') }}" target="_blank">
        ...
        <span
          class="{{ (true ? 'mr-1' : 'ml-1') }} font-semibold transition-all duration-200 ease-nav-brand">Soft
          UI Dashboard</span>
      </a>
    </div>
      ...
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (true ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Tables</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (true ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Billing</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (true ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Virtual
              Reality</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors
            ...
            <span
              class="{{ (true ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Profile</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
            ...
            <span
              class="{{ (true ? 'mr-1' : 'ml-1') }} duration-300 opacity-100 pointer-events-none ease-soft">Sign
              In</span>
          </a>
        </li>

...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="{{ asset('img/favicon.svg') }}" media="(prefers-color-scheme: light)" />
    <link rel="icon" type="image/svg+xml" href="{{ asset('imgs/darkfavicon.svg') }}" media="(prefers-color-scheme: dark)" />
    ...
    <meta property="og:image" content="{{asset('imgs/og-cover.png')}}" />
    ...
    <meta name="twitter:image" content="{{asset('imgs/og-cover.png')}}" />
        ...
        <div class="relative pt-24 lg:pt-28">
            <div class="mx-auto px-6 max-w-7xl md:px-12">
                <div class="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
                    ...
                    <p class="text-wrap mx-auto mt-6 max-w-2xl text-gray-700 dark:text-gray-300 sm:hidden">Highly customizable components for building modern websites and applications, with your personal spark.</p>
                                    ...
                                    <div class="relative space-y-6 py-6 flex flex-col justify-center h-full">
                                        <div class="flex items-center justify-end gap-2 w-[calc(50%+0.875rem)] relative">
                                            ...
                                            <div class="size-7 ring-4 ring-white dark:ring-[--card-dark-bg]">
                                                <img class="rounded-full  border border-gray-950/5 dark:border-white/5 size-full" src="{{asset('imgs/OlbJkLL0_400x400.jpg')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-2 ml-[calc(50%-1rem)] relative">
                                            <div class="size-8 ring-4 ring-white dark:ring-[--card-dark-bg]">
                                                <img class="rounded-full  border border-gray-950/5 dark:border-white/5 size-full" src="{{ asset('imgs/124.jpg') }}" alt="">
                                            </div>

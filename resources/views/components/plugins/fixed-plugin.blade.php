<div fixed-plugin>
    <a fixed-plugin-button class="bottom-7.5 {{ (true ? 'left-7.5' : ' right-7.5') }} {{--Request::is('rtl')--}} text-size-xl z-990 shadow-soft-lg rounded-circle fixed cursor-pointer bg-white px-4 py-2 text-slate-700">
        <i class="py-2 pointer-events-none fa fa-cog"> </i>
    </a>
    <!-- -right-90 in loc de 0-->
    <div fixed-plugin-card class="z-sticky shadow-soft-3xl w-90 ease-soft {{ (true ? '-left-90 right-auto' : '-right-90 left-auto') }} {{--Request::is('rtl')--}} fixed top-0 flex h-full min-w-0 flex-col break-words rounded-none border-0 bg-white bg-clip-border px-2.5 duration-200">
        <div class="px-6 pt-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
            <div class="{{ (true ? 'float-right' : 'float-left') }} {{--Request::is('rtl')--}}">
                <h5 class="mt-4 mb-0">Soft UI Configurator</h5>
                <p>See our dashboard options.</p>
            </div>
            <div class="{{ (true ? 'float-left' : 'float-right') }} {{--Request::is('rtl')--}} mt-6">
        ...
        <div class="flex-auto p-6 pt-0 sm:pt-4">
            ...
            <a href="javascript:void(0)">
                <div class="my-2 {{ (true ? 'text-right' : 'text-left') }} {{--Request::is('rtl')--}}" sidenav-colors>
            ...
            <div class="min-h-6 mb-0.5 block pl-0">
                <input navbarFixed class="rounded-10 duration-250 ease-soft-in-out after:rounded-circle after:shadow-soft-2xl after:duration-250 h-5-em relative {{ (true ? 'checked:after:-translate-x-5.25 float-right mt-1 mr-auto bg-right after:-translate-x-px' : 'checked:after:translate-x-5.25 float-left mt-1 ml-auto bg-left after:translate-x-px') }}{{--Request::is('rtl')--}} w-10 cursor-pointer appearance-none border border-solid border-gray-200 bg-slate-800/10 bg-none bg-contain  bg-no-repeat align-top transition-all after:absolute after:top-px after:h-4 after:w-4 after:bg-white after:content-[''] checked:border-slate-800/95 checked:bg-slate-800/95 checked:bg-none checked:bg-right" type="checkbox" />
            </div>
